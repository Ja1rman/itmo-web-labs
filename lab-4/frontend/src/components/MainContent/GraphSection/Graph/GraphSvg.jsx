...
const GraphSvg = (props) => {
  return (
    <svg width="220" height="220" xmlns="http://www.w3.org/2000/svg">
      ...
      {/* Triangle */}
      <polygon points="143,110 110,110 110,176"
        fill="red" fillOpacity="0.25" stroke="darkred" strokeOpacity="0.5" />

      {/* Rectangle */}
      <polygon points="43,76 43,110 110,110 110,76"
        fill="blue" fillOpacity="0.25" stroke="darkblue" strokeOpacity="0.5" />

      {/* Circle */}
      <path d="M 176 110 A 66 66 0 0 0 110 43 L 110 110 Z"
        fill="orange" fillOpacity="0.25" stroke="#FF7A12" strokeOpacity="0.5" />
    </svg>
  );
}
